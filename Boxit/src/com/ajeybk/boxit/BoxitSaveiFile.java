 ...
 *
 */
public class BoxitSaveiFile extends ArrayList {
	FileInputStream fsInput;
	boolean readMode = true;
	FileOutputStream fsOutput;
	
	public BoxitSaveiFile(FileOutputStream fos) {
		  fsOutput = fos;
		  readMode = false;
	}
   ...
   */
  public BoxitSaveiFile(FileInputStream fis) {
	  fsInput = fis;
	  readMode = true;
	  clear();
  }
  ...
  public boolean readFile(){
	  try {
		  Reader reader = new InputStreamReader(fsInput); 
  ...
  public boolean UpdateFile() {
    try {
      Writer writer = new OutputStreamWriter(fsOutput);
